      ...
      <motion.div
        ...
        <Card
          ...
          <motion.div
            ...
            <motion.div
              className="absolute inset-0 bg-linear-to-r from-[#2DD4BF] to-[#38BDF8] rounded-full shadow-lg"
              animate={{ rotate: 360 }}
          ...
          <motion.div
            ...
            <Button
              className="mt-6 bg-linear-to-r from-[#2DD4BF] to-[#38BDF8] hover:from-[#2DD4BF]/90 hover:to-[#38BDF8]/90 text-white px-6 py-3 rounded-full text-lg font-semibold shadow-lg transition-all duration-300 hover:scale-105">
        ...
        <div className="space-y-8">
          ...
          <Card
            ...
            <motion.div
              ...
              <div className="flex justify-between items-center">
                <h2
                  className="text-2xl font-bold text-transparent bg-clip-text bg-linear-to-r from-[#2DD4BF] to-[#38BDF8]">
                  About Me
                </h2>
                <Badge
                  variant="secondary"
          ...
          <Card
            className="p-6 shadow-xl rounded-2xl backdrop-blur-lg bg-[#1E293B]/50 border border-[#2DD4BF]/20 overflow-hidden">
            <h2
              className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-linear-to-r from-[#2DD4BF] to-[#38BDF8]">
              Latest Roles
            </h2>
            <motion.div
              className="space-y-6"
              ...
              <motion.div className="flex items-center gap-4" whileHover={{ x: 10 }}>
                <motion.div
                  className="w-16 h-16 bg-linear-to-br from-[#2DD4BF] to-[#38BDF8] rounded-2xl flex items-center justify-center shadow-lg"
